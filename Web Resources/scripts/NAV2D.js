...
NAV2D.Navigator = function(options) {
  ...
  //Topic to listen to for the robots pose from robot_pose_publisher
  var poseTopic = options.poseTopic || '/robot_pose';
  
  //Color option for the robot marker
  var makerFillColor = options.markerFillColor || createjs.Graphics.getRGB(255, 128, 0, 0.66);
  ...
  // marker for the robotnav
  var robotMarker = new ROS2D.NavigationArrow({
    size : 40, //original 25
    strokeSize : 1,
    fillColor : options.markerFillColor,
    pulse : false //original true
  });
