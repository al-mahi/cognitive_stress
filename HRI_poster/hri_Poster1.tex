...
\headerbox{Motivations and Contributions}{name=motivations,column=0,span=1,below=objectives}{ 
	\textbf{Motivation:}
    \begin{itemize}
...
\headerbox{Physiological Metrics}{name=trivial,column=0,below=motivations}{
...
%  \vspace{0.5em}
  	\begin{minipage}{\textwidth}
  	    ...
  	    \pgfdeclareimage[height= 2.5 cm, width = 7 cm]{metrics_E_H}{./figures/metrics_E_H}
  	    \centering
