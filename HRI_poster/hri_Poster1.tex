...
\headerbox{Prediction vs Evidence}{name=demos,column=1,below=methodology}{ 
  ...
  The robot correctly predicts an operator's cognitive load. Figure Fig. shows modest correlation between
physiological evidence  of an operator and the robot's estimation of stress.
  \centering
  \pgfuseimage{res2}
