...
Most important contribution of our model can has been demonstrated from the perpective of task success. The task success of the coin game is measured in term of number of coins collected withing given time. Our experiment shows that by switching to autonomous mood on detection of high stress level of human operator can significantly improve the task success \ref{tab:task_success}.

% Please add the following required packages to your document preamble:
% \usepackage{booktabs}
\begin{table}[]
\centering
\caption{Task success comparsions between autonomous assistance mood and manual mood. Automous assistance was activated on detection of high stress level predicted by our model.}
\label{my-label}
\begin{tabular}{@{}|c|c|c|c|c|@{}}
\toprule
Game Mood                                                                                  & \multicolumn{2}{c|}{Manual} & \multicolumn{2}{c|}{Auto} \\ \midrule
\begin{tabular}[c]{@{}c@{}}Number of\\ Robots in\\ Participated\end{tabular}               & one          & two          & one         & two         \\ \midrule
...
In the context of this paper, it also supports the
