...
\begin{figure}  
\centering
\subfloat[One robot]{\label{fig:final-results_a}\includegraphics[width=.5\textwidth]{One_Robot_vs_Observer_CLE.eps}}\\
\subfloat[Two robots]{\label{fig:final-results_b}\includegraphics[width=.5\textwidth]{Two_Robots_vs_Observer_CLE.eps}}	
