...
\begin{figure}  
\centering
\subfloat[One robot]{\label{fig:finalresults_a}\includegraphics[width=.5\textwidth]{One_Robot_vs_Observer_CLE.eps}}\\
\subfloat[Two robots]{\label{fig:finalresults_b}\includegraphics[width=.5\textwidth]{Two_Robots_vs_Observer_CLE.eps}}	
