...
class GameModel {
	...
	struct RunData  {
		 ...
		 */
		RunData(std::string robotName, bool runMazeBefore, std::vector<double> goalArivalTimes, std::vector<int32_t> healthAtGoal, std::vector<double> percentDamage, std::vector<geometry_msgs::Point> givenPoints, std::vector<geometry_msgs::Point> expectedPoints, std::vector<geometry_msgs::Point> disparity, std::vector<double> goalArrivalDelay, std::vector<double> trustScores, std::map<int, std::vector<double>> goalFrequencyForPoints) {
			...
			this->goalArrivalDelay = goalArrivalDelay;
...
public:
	 ...
	 */
	void submitAndUpdateAverageScores(std::string name, std::vector<double> times, std::vector<int32_t> healthPonits, std::vector<double> percentDamage, std::vector<geometry_msgs::Point> givenPoints, std::vector<geometry_msgs::Point> expectedPoints, std::vector<geometry_msgs::Point> disparity, std::vector<double> inputDelay, std::vector<double> trustScores, std::map<int, std::vector<double>> goalFrequencyForPoints);
