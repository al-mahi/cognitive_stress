...
int main(int argc, char** argv) {
	...
	ros::ServiceServer requesetMazePoints = nh.advertiseService("request_maze_points", &MazeGame::requestMazeMarkers, &game);

	//Score Averaging Services
	ros::ServiceServer requestAverageScores = nh.advertiseService("request_average_scores", &MazeGame::requestAverageScores, &game);
...
bool MazeGame::requestMazeMarkers(maze_game::RequestMazeMarkers::Request &req, maze_game::RequestMazeMarkers::Response &res) {
	model->publishMazeMarkers();
	res.done = "done";
	return true;
}

bool MazeGame::requestAverageScores(maze_game::RequestAverageScores::Request &req, maze_game::RequestAverageScores::Response &res) {
